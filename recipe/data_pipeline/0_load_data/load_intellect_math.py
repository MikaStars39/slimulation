...
def load_klearreasoner(
    ...
    dataset = load_dataset(dataset_name, "math", split="train",)
    ...
    for idx, row in enumerate(tqdm(dataset, desc=f"Loading {dataset_name}")):
        ...
        for sample_idx in range(k):
            ...
            unique_id = f"INTELLECT-3-RL-Math_{idx}_{sample_idx}"
            
            record = {
                "id": unique_id,
                "question_id": f"INTELLECT-3-RL-Math_{idx}",
                "source": "INTELLECT-3-RL-Math",
                "prompt": question,
...
if __name__ == "__main__":
    output_dir = "/mnt/llm-train/users/explore-train/qingyu/data/stage_1/INTELLECT-3-RL-Math"
