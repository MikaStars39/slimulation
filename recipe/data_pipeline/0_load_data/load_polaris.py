...
def load_klearreasoner(
    ...
    for idx, row in enumerate(tqdm(dataset, desc=f"Loading {dataset_name}")):
        ...
        for sample_idx in range(k):
            ...
            unique_id = f"Polaris-Dataset-53K_{idx}_{sample_idx}"
            
            record = {
                "id": unique_id,
                "question_id": f"Polaris-Dataset-53K_{idx}",
                "source": "Polaris-Dataset-53K",
                "prompt": question,
...
if __name__ == "__main__":
    output_dir = "/mnt/llm-train/users/explore-train/qingyu/data/stage_1/Polaris-Dataset-53K"

    # first make dictionary
    os.makedirs(output_dir, exist_ok=True)
    
    load_klearreasoner(
        dataset_name="/mnt/llm-train/users/explore-train/qingyu/.cache/Polaris-Dataset-53K",
        k=1,
